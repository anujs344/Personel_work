...
<form action="report" method="POST" >
    <input name="Problem" placeholder="Enter your Problem">
    <label>Your Company Name is</label>
    <input name="Cname" value="{{$_GET['CompanyName']}}" disabled>
    <input type="submit">
</form>
@else
...
<body >
    ...
    <section class="main__conatiner" style="background: color #3E4095;">
        <header class="header" style="background-color:#3E4095;">
            <div class="top__row">
                ...
                <div class="nav__row">
                    <div class="site__fix">
                        <a href="" title="whistleb" class="logo"> <img src="{{assets('images/logos.jpeg')}}" alt="whistleb" height="100%"></a>
                                    ...
                                    <ul>
                                        ...
                                        <li>
                                            <div class="col__1">
                                                ...
                                                <input type="text" class="input" name="Cname" value="{{$_GET['CompanyName']}}" />
                                            </div>
                                        </li>
    ...
    <script src="{{assets('js/libs/wow.js')}}" type="text/javascript" charset="utf-8" async defer></script>
